...
meta:
  id: crocube
  title: CroCube FSK and CW Beacon and Digi Decoder
  endian: be
doc-ref: "https://crocube.hr/wp-content/uploads/2022/12/CroCube_AmateurRadioInfo_2024-09-15.pdf"
# 2024-12-21, DL7NDR (extends the original version by features for digipeater and adds cw beacon decoder)
doc: |
    ...
    seq:
      - id: id2
        type:
          ...
          cases:
            0x6465203961306363: cw_message # de 9a0cc
            _: not_cw_message
  ...
  cw_message:
   seq:
     - id: de_9a0cc
       ...
       size: 12
       encoding: ASCII
       valid: '"de 9a0cc = u"' # 64 65 20 39 61 30 63 63 20 3D 20 75
    ...
    types:
      ax25_frame:
        ...
        instances:
          ...
          mgs_beacon_raw:
            value: '"MGS,"+mgs_temp_int_mag_str+","+mgs_temp_int_gyr_str+","+mgs_int_mag_x_str+","+mgs_int_mag_y_str+","+mgs_int_mag_z_str+","+mgs_int_gyr_x_str+","+mgs_int_gyr_y_str+","+mgs_int_gyr_z_str+","+mgs_temp_ext_mag_str+","+mgs_temp_ext_gyr_str+","+mgs_ext_mag_x_str+","+mgs_ext_mag_y_str+","+mgs_ext_mag_z_str+","+mgs_ext_gyr_x_str+","+mgs_ext_gyr_y_str+","+mgs_ext_gyr_z_str'
    ...
    types:
      ax25_frame:
        ...
        instances:
          ...
          obc_beacon_raw:
            value: '"OBC,"+obc_rst_cnt_str+","+obc_uptime_str+","+obc_uptime_tot_str+","+obc_bat_str+","+obc_temp_mcu_str+","+obc_freemem_str'
    ...
    types:
      ax25_frame:
        ...
        instances:
          ...
          psu_beacon_raw:
            value: '"PSU,"+psu_rst_cnt_str+","+psu_uptime_str+","+psu_uptime_tot_str+","+psu_bat_str+","+psu_temp_sys_str+","+psu_temp_bat_str+","+psu_cur_in_str+","+psu_cur_out_str+","+psu_ch_state_str+","+psu_sys_state_str+","+psu_gnd_wdt_str'
    ...
    types:
      ax25_frame:
        ...
        instances:
          ...
          sol_beacon_raw:
            value: '"SOL,"+sol_temp_zp_str+","+sol_temp_xp_str+","+sol_temp_yp_str+","+sol_temp_zn_str+","+sol_temp_xn_str+","+sol_temp_yn_str+","+sol_diode_zp_str+","+sol_diode_xp_str+","+sol_diode_yp_str+","+sol_diode_zn_str+","+sol_diode_xn_str+","+sol_diode_yn_str'
    ...
    types:
      ax25_frame:
        seq:
          ...
          - id: atr_pass_packet_type
            type: str
            terminator: 0x2C
            encoding: utf8
            valid: '"ATR"'
          - id: atr_master_id_str
            type: str
            terminator: 0x2C
            encoding: utf8
          - id: atr_defective_devices_str
            type: str
            terminator: 0x2C
            encoding: utf8
          - id: atr_device_reset_1_str
            type: str
            terminator: 0x2C
            encoding: utf8
          - id: atr_device_reset_2_str
            type: str
            terminator: 0x2C
            encoding: utf8
          - id: atr_device_reset_3_str
            type: str
            terminator: 0x2C
            encoding: utf8
          - id: atr_device_uptime_1_str
            type: str
            terminator: 0x2C
            encoding: utf8
          - id: atr_device_uptime_2_str
            type: str
            terminator: 0x2C
            encoding: utf8
          - id: atr_device_uptime_3_str
            type: str
            terminator: 0x2C
            encoding: utf8
          - id: atr_checksum_str
        ...
        instances:
          atr_master_id:
            value: atr_master_id_str.to_i
          atr_defective_devices:
            value: atr_defective_devices_str.to_i
          atr_device_reset_1:
            value: atr_device_reset_1_str.to_i
          atr_device_reset_2:
            value: atr_device_reset_2_str.to_i
          atr_device_reset_3:
            value: atr_device_reset_3_str.to_i
          atr_device_uptime_1:
            value: atr_device_uptime_1_str.to_i
          atr_device_uptime_2:
            value: atr_device_uptime_2_str.to_i
          atr_device_uptime_3:
            value: atr_device_uptime_3_str.to_i
          atr_checksum:
            value: atr_checksum_str.to_i
          atr_beacon_raw:
            value: '"ATR,"+atr_master_id_str+","+atr_defective_devices_str+","+atr_device_reset_1_str+","+atr_device_reset_2_str+","+atr_device_reset_3_str+","+atr_device_uptime_1_str+","+atr_device_uptime_2_str+","+atr_device_uptime_3_str+","+atr_checksum_str'
      ...
      - id: id5
        type:
          ...
          cases:
            0x552C: u # U,
            0x562C: v # V,
            _: crocube_message # AX.25 message from CroCube
    ...
    types:
      ax25_frame:
        ...
        instances:
          ...
          uhf_beacon_raw:
            value: '"U,"+uhf_uptime_str+","+uhf_uptime_tot_str+","+uhf_reset_cnt_str+","+uhf_rf_reset_cnt_str+","+uhf_trx_temp_str+","+uhf_rf_temp_str+","+uhf_pa_temp_str+","+uhf_digipeater_cnt_str+","+uhf_last_digipeater_str+","+uhf_rx_cnt_str+","+uhf_tx_cnt_str+","+uhf_act_rssi_raw_str+","+uhf_dcd_rssi_raw_str'
    ...
    types:
      ax25_frame:
        ...
        instances:
          ...
          vhf_beacon_raw:
            value: '"V,"+vhf_uptime_str+","+vhf_uptime_tot_str+","+vhf_reset_cnt_str+","+vhf_rf_reset_cnt_str+","+vhf_trx_temp_str+","+vhf_rf_temp_str+","+vhf_pa_temp_str+","+vhf_digipeater_cnt_str+","+vhf_last_digipeater_str+","+vhf_rx_cnt_str+","+vhf_tx_cnt_str+","+vhf_act_rssi_raw_str+","+vhf_dcd_rssi_raw_str'
