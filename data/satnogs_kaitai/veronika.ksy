...
meta:
  id: veronika
  title: Veronika FSK and CW Beacon and Digi Decoder
  endian: be
doc-ref: "https://kozmonautika.sk/2023/11/08/tretia-slovenska-druzica-mieri-do-vesmiru-vsetky-informacie-na-jednom-mieste/"
# 2024-10-24, DL7NDR (extends the original version by features for digipeater and adds cw beacon decoder)
doc: |
    ...
    seq:
      - id: id2
        type:
          ...
          cases:
            0x6465206F6D397665: cw_message # de om9ve
            _: not_cw_message
  ...
  cw_message:
   seq:
     - id: de_om9ver
       ...
       size: 13
       encoding: ASCII
       valid: '"de om9ver = u"' # 64 65 20 6F 6D 39 76 65 72 20 3D 20 75
      ...
      - id: id5
        type:
          ...
          cases:
            0x552C: u # U,
            0x562C: v # V,
            _: veronika_message # AX.25 message from Veronika
